...
cf_time='Tue Mar  1 17:51:37 UTC 2016'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_argc='36'
config_args='-Dusethreads -Duselargefiles -Dccflags=-DDEBIAN -D_FORTIFY_SOURCE=2 -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security -Dldflags= -Wl,-Bsymbolic-functions -Wl,-z,relro -Dlddlflags=-shared -Wl,-Bsymbolic-functions -Wl,-z,relro -Dcccdlflags=-fPIC -Darchname=arm-linux-gnueabihf -Dprefix=/usr -Dprivlib=/usr/share/perl/5.18 -Darchlib=/usr/lib/perl/5.18 -Dvendorprefix=/usr -Dvendorlib=/usr/share/perl5 -Dvendorarch=/usr/lib/perl5 -Dsiteprefix=/usr/local -Dsitelib=/usr/local/share/perl/5.18.2 -Dsitearch=/usr/local/lib/perl/5.18.2 -Dman1dir=/usr/share/man/man1 -Dman3dir=/usr/share/man/man3 -Dsiteman1dir=/usr/local/man/man1 -Dsiteman3dir=/usr/local/man/man3 -Duse64bitint -Dman1ext=1 -Dman3ext=3perl -Dpager=/usr/bin/sensible-pager -Uafs -Ud_csh -Ud_ualarm -Uusesfio -Uusenm -Ui_libutil -Uversiononly -DDEBUGGING=-g -Doptimize=-O2 -Duseshrplib -Dlibperl=libperl.so.5.18.2 -des'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
myuname='linux kishi12 3.2.0-98-highbank #138-ubuntu smp preempt mon jan 11 13:24:41 utc 2016 armv7l armv7l armv7l gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/arm-linux-gnueabihf/4.8 /lib/arm-linux-gnueabihf /lib/../lib /usr/lib/arm-linux-gnueabihf/4.8 /usr/lib/arm-linux-gnueabihf /usr/lib/../lib /lib /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
